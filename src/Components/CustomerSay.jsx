        ...
        <div className="mt-10">
            <div className="flex justify-center items-center lg:flex-row md:flex-row flex-col  mt-12">
                ...
                <div className=" items-start p-5">
                    ...
                    <h1 className="lg:text-4xl md:text-3xl text-2xl mt-4 mb-5 font-extrabold text-black line leading-tight">What Our Customers <br /> Say <span className="text-color2">About</span> Us</h1>
