        ...
        <footer className="p-10 bg-base-200 text-base-content mt-8">
            <div className="container mx-auto footer">
                ...
                <div>
                    ...
                    <div className="flex">
                        <button className="flex items-center btn btn-md bg-black  text-white hover:bg-black mr-3">
                        ...
                        <button className="flex items-center btn bg-black  text-white hover:bg-black">
            ...
            <aside className="flex justify-center">
                <p className="text-center text-sm md:text-base">{moment().format('YYYY')} All right reserved by <span className="text-pink-900 font-bold italic"> WindDelivery</span></p>
            </aside>
        </footer>
