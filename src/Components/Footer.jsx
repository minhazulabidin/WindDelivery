    ...
    return (
        <footer className="md:px-10 px-4 pt-10 pb-4 bg-base-200 text-base-content mt-8">
            <div className="container mx-auto footer">
                ...
                <div>
                    <h1 className="font-black lg:text-2xl text-xl font-poppins text-color2">Have you got our app?</h1>
                    <p className="font-poppins lg:text-lg text-base">Best cook and best delivery guys all at your service.</p>
                    <div className="flex">
                        <button className="flex items-center btn btn-md bg-color text-[#fff] hover:bg-[#000] mr-3">
                        ...
                        <button className="flex items-center btn bg-color text-[#fff] hover:bg-[#000]">
