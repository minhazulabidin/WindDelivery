...
const AddFood = () => {
  ...
  const handleAddFood = (e) => {
    ...
    axios.post('https://winddelivery-server-kpavvra3a-minhazs-projects.vercel.app/products', food)
      .then(res => {
    ...
    axios.post('https://winddelivery-server-kpavvra3a-minhazs-projects.vercel.app/products2', food)
      .then(res => {
        if (res.data.insertedId) {
          form.reset();
        }
  ...
  return (
    <div className="container mx-auto">
      ...
      <form className="my-10 mx-auto" onSubmit={handleAddFood}>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <select name='area' id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <button type="submit" className="text-[#fff] hover:bg-color2 bg-color2 btn ">Submit</button>
      </form>
