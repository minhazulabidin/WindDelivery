...
const Cart = () => {
    ...
    useEffect(() => {
        fetch(`https://winddelivery-server-610hdeq2f-minhazs-projects.vercel.app/products/cart?ids=${items}`)
            .then(res => res.json())
            .then(data => {
    ...
    const handleCheckout = async () => {
        const postData = await axios.post('https://winddelivery-server-610hdeq2f-minhazs-projects.vercel.app/addCart', products)
