...
const MyAddFood = () => {
  ...
  useEffect(() => {
    axios.get(`https://winddelivery-server.vercel.app/orders?email=${user?.email}`, { withCredentials: true })
  ...
  const handleFoodDelete = id => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://winddelivery-server.vercel.app/orders/${id}`)
          .then(res => res.data)
        axios.delete(`https://winddelivery-server.vercel.app/product/${id}`)
          .then(res => res.data)
